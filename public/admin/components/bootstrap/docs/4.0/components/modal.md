...
[Tooltips]({{ site.baseurl }}/docs/{{ site.docs_version }}public/admin/components/tooltips/) and [popovers]({{ site.baseurl }}/docs/{{ site.docs_version }}public/admin/components/popovers/) can be placed within modals as needed. When modals are closed, any tooltips and popovers within are also automatically dismissed.
