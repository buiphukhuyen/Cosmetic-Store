...
- It must be used on a Bootstrap [nav component]({{ site.baseurl }}/docs/{{ site.docs_version }}public/admin/components/navs/) or [list group]({{ site.baseurl }}/docs/{{ site.docs_version }}public/admin/components/list-group/).
