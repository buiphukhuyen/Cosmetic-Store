...
Using the [card]({{ site.baseurl }}/docs/{{ site.docs_version }}public/admin/components/card/) component, you can extend the default collapse behavior to create an accordion.
