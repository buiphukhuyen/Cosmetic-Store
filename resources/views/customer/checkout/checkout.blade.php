                ...
                <div class="large-12 col">
                    <div class="col-inner">
                        <div class="woocommerce">
                            ...
                            <div class="woocommerce-notices-wrapper"></div>
                            <form name="checkout" method="post" class="checkout woocommerce-checkout " action="{{URL::to('/save-shipping-order-customer')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row pt-0 ">
                                                    ...
                                                    <div id="payment" class="woocommerce-checkout-payment">
                                                        <ul class="wc_paymefnt_methods payment_methods methods">
                                                            ...
                                                            <li class="wc_payment_method payment_method_cod">
                                                                <input id="payment_method_cod" type="radio" class="input-radio" name="payment_option" value="Trả tiền mặt khi nhận hàng"  data-order_button_text="" />
